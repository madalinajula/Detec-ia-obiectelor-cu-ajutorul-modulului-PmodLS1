...
HD_PWD='D:/An 3 Sem 1/SSC/Proiect_SSC/Proiect_SSC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PModLS1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PModLS1.tcl -notrace
