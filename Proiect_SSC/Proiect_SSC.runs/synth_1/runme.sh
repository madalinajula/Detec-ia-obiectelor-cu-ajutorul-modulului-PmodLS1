...
HD_PWD='D:/An 3 Sem 1/SSC/Proiect_SSC/Proiect_SSC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PModLS1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PModLS1.tcl
